*** Summary:
The artifacts supporting this study are publicly available to enable reproducibility and independent validation of the reported results. The repository includes:
- Source documents used for knowledge ingestion
- Data ingestion and chatbot interaction scripts
- Benchmark question sets with corresponding answer keys
- Red-teaming evaluation scenarios
- Input files containing reviewer evaluation scores
- Analysis scripts for HRPIS operational statistics, helpdesk-related metrics, and Scrum-based process analysis
- Comparative evaluation pipelines for pure LLM and RAG-based chatbot approaches

All experimental results reported in this paper can be regenerated by executing the analysis scripts provided in the corresponding repository directories.
...
@misc{alhawari2026hrpis,
  author = {Feras Al-Hawari, Anoud Alufeishat, Mohammad Habahbeh, and Ahmad Alfalayleh},
...
- For example: 
Feras Al-Hawari, Anoud Alufeishat, Mohammad Habahbeh, and Ahmad Alfalayleh. (2026). HRPIS and RAG-Based Chatbot Evaluation Artifacts [Computer Software]. https://github.com/firasalhawari/hrpis_rag_chatbot_evaluation

- Paper:
Feras Al-Hawari, Anoud Alufeishat, Mohammad Habahbeh, and Ahmad Alfalayleh. Scrum-Guided Development of an Intelligent Payroll Management System with Rule-Based Automation and RAG Chatbot Support, Knowledge-Based Systems, 2026.
