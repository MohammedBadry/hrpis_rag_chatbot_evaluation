...
RESULTS_CSV = OUTPUT_DIR / "chatbot_eval_hybrid_trans.csv"
RESULTS_JSON = OUTPUT_DIR / "chatbot_eval_hybrid_trans.json"
...
# Questions
# -----------------------------
questions =["Basic salary?",
    "What is the basic salary?",
    "What is the basic salary definition?",
    "Transportation allowance",
    "Transportation allowance?",
    "List transportation allowance values for all",
    "List transportation allowance values for all, including dean",
    "Family allowance?",
    "Family bonus?",
